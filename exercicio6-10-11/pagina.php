<?php 
	...
	//echo "Aleatorio $al";
	if($num <> $al){
		if($num > $vetor){echo "<br> Valor digitado maior que o numero gerado ($num)<br>";}
		if($num < $vetor){echo "<br> Valor digitado menor que o numero gerado ($num)<br>";}
		echo "<fieldset>";
		echo "<legend>Você Errou!!!</legend>";
		echo "<form method='post' action='sorte.php'>";
